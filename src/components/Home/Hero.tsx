  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img 
          src={heroImage} 
          alt="Fine dining experience at Bella Vista"
      ...
      <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
        ...
        >
          ...
          >
            Indulge in culinary excellence where every dish tells a story of passion, 
            creativity, and the finest ingredients sourced from around the world.
          </motion.p>
          ...
          >
            ...
            <Button 
              ...
              variant="outline"
              size="lg"
              className="border-white/30 text-white hover:bg-white/10 backdrop-blur-sm font-semibold px-8 py-4 rounded-full transition-all duration-300"
            >
