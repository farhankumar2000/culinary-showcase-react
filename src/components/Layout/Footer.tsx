            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-accent-foreground/80 leading-relaxed">
                            Experience fine dining like never before. We bring
                            authentic flavors and exceptional service to create
                            unforgettable moments.
                        </p>
                        <div className="flex space-x-4">
                            <a
                                href="#"
                                className="text-accent-foreground/60 hover:text-primary transition-colors duration-300">
                ...
                <div className="border-t border-accent-foreground/20 mt-8 pt-8 text-center">
                    <p className="text-accent-foreground/60 text-sm">
                        ...
                        Crafted with passion for exceptional dining.
                    </p>
                </div>
            </div>
        </footer>
